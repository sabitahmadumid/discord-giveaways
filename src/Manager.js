...
class GiveawaysManager extends EventEmitter {
    ...
    async _init() {
        ...
        await (this.client.readyAt ? Promise.resolve() : new Promise((resolve) => this.client.once(Discord.Events.ClientReady, resolve)));
        ...
        this.client.on(Discord.Events.Raw, (packet) => this._handleRawPacket(packet));
    }
}
